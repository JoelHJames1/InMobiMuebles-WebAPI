using InMobiMuebles_WebAPI.Models;
...
namespace RealEstateApi.Data
{
    public class ApiDbContext : DbContext
    {
        ...
        public DbSet<PropertyPhoto> PropertiesPhoto { get; set; }   
        public DbSet<Bookmark> Bookmarks { get; set; }

        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer(@"Data Source=SQL5097.site4now.net;Initial Catalog=db_a932da_joelhjames614;User Id=db_a932da_joelhjames614_admin;Password=Jolopero55@");
