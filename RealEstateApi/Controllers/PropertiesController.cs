...
namespace RealEstateApi.Controllers
{
    ...
    public class PropertiesController : ControllerBase
    {
        ...
        [HttpGet("PropertyPhotos")]
        [Authorize]
        public IActionResult GetPropertyPhotos(int PropertyID)
        {
            var propertiesResult = _dbContext.PropertiesPhoto.Where(c => c.PropertyId == PropertyID);
            if (propertiesResult == null)
            {
                return NotFound();
            }
